...
pub(crate) struct ChatWidget {
    ...
    plugin_detail_return_selected_idx: Option<usize>,
...
impl ChatWidget {
    ...
    pub(crate) fn sync_plugin_mentions_config(&mut self, config: &Config) {
        ...
        self.local_settings.tui.fork.file_mentions_preserve_at =
            config.fork_tui.file_mentions_preserve_at;
        self.local_settings
            .tui
            .fork
            .file_mentions_allow_explicit_paths =

...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let placeholder =
            select_chatbox_placeholder(local_settings.tui.fork.chatbox_placeholder_tips);
        ...
        widget.sync_file_mention_settings();
        widget
            .bottom_pane
...
fn select_chatbox_placeholder(tips: ChatboxPlaceholderTips) -> String {
    match tips {
